...
namespace BetterWaveSkipper
{
    public static class CWRUtils
    {
        ...
        public static void OnModifyTooltips(Mod mod, Item item, List<TooltipLine> tooltips, string key, int leva = 1) {
            ...
            TooltipLine newLine = new TooltipLine(mod, "BetterWaveSkipperText"
                , Language.GetText($"Mods.BetterWaveSkipper.Items.{key}.Tooltip").Value);
        ...
        /// 发收统一端口的实例
        /// </summary>
        public static ModPacket Packet => BetterWaveSkipper.Instance.GetPacket();
        /// <summary>
